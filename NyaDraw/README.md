...
* `pastebin get x /usr/lib/NyaDraw.lua` to load a standart version of library (31Kb)


* `pastebin get x /usr/lib/NyaDrMini.lua` to load a minified (but full-functional) version of library (13Kb)
