...
tty.clear()
print('TapFAT Filesystem Driver')
print('Copyright (C) 2021 Compys S&N Systems')
print('For more information go to: https://github.com/Bs0Dd/OpenCompSoft/blob/master/TapFAT/README.md\n')
...
local properties = {
	GUIElementsOffset = 2,
	localization = {
		title = "Installing TapFAT Filesystem Driver...",
		currentFile = "Downloading \"<currentFile>\"",
		totalProgress = "Total progress: <totalProgress>%",
		finished1 = "TapFAT has been successfully installed",
		finished2 = "Type \"tfatinit\" to run mounter",
		finished3 = "Or type \"tfattool\" for setup",
